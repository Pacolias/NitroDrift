...
public class Ejemplo extends ApplicationAdapter {
	private static final long TNANO = 1000000000;
	private Texture imgObstaculo, imgBarco, imgBarcoRev, nitroDrift, fondoInicio, fondoBarco;
	private Sound sonidoGolpe;
	private Music musicaDeFondo;
	private SpriteBatch gestorDeGraficos;
	private OrthographicCamera camara;
	private Rectangle barco;
	private Array<Rectangle> obstaculos;
	private long tiempoUltimoObstaculo;
	private String dirBarco;

	private enum Estado {
		INICIO, CARRERA, CONFIGURACION
	};
	...
	public void create() {
		...
		nitroDrift = new Texture(Gdx.files.internal("nitroDrift.png"));
	...
	private void dibujarInicio() {
		...
		gestorDeGraficos.draw(nitroDrift, 0, 0);
		gestorDeGraficos.end();

		if (Gdx.input.isTouched())
			estadoActual = Estado.CONFIGURACION;
	}
